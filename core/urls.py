...
urlpatterns = patterns('',
    ...
    url(r'^question/create/$', login_required(QuestionCreateView.as_view()), name='question_list'),
    url(r'^question/(?P<pk>\d+)/$', login_required(QuestionDetailView.as_view()), name='question_list'),
